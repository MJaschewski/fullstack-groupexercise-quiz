...
class QuizController_IntegrationTests {
    ...
    void getMapping_getCategoryList_return_200Ok_return_Categories() throws Exception{
     ...
     @Test
     void getMapping_getCategoryList_return_200Ok_return_CategoriesFromApi() throws Exception{
         mockMvc.perform(MockMvcRequestBuilders.get("https://opentdb.com/api_category.php"))
                 .andExpect(MockMvcResultMatchers.status().isOk())
